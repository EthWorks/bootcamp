...
describe('Ether Splitter', () => {
  ...
  it('Splits even amount of ether', async () => {
    let initialBalance = await second.getBalance()
  ...
  it('Splits uneven amount of ether', async () => {
    let firstInitialBalance = await first.getBalance()
    let secondInitialBalance = await second.getBalance()
    let walletInitialBalance = await wallet.getBalance()
